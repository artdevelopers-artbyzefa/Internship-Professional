            ...
            {gradeData.length > 0 && (
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                    <div className="px-8 py-5 border-b border-gray-50 flex items-center gap-3">
                        ...
                        <h3 className="font-black text-gray-800 tracking-tight">{isPhase4 ? 'Final Evaluation Summary' : 'Intern Faculty Grades'}</h3>
                        <span className="text-[9px] font-black uppercase tracking-widest bg-indigo-50 text-indigo-500 px-2 py-0.5 rounded-full border border-indigo-100">{isPhase4 ? 'Acquired Performance Metrics' : 'Assigned by Faculty Supervisor'}</span>
                    </div>
